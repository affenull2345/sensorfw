...
#ifndef IIOALSADAPTOR_H
#define IIOALSADAPTOR_H
...
/**
 * @brief Adaptor for Industrial I/O ambient light sensors.
 */
class IioAlsAdaptor : public IioAdaptor
{
    Q_OBJECT

public:
    static DeviceAdaptor *factoryMethod(const QString &id) {
        return new IioAlsAdaptor(id);
    }

    IioAlsAdaptor(const QString &id);
